...
// 🚫 Disabled Basehub CMS (not needed for assignment)

export const Toolbar = () => null;
export const Feed = () => null;

export const basehub = {};
export const fragmentOn = () => null;

// If other code tries to use blog/legal exports, stub them out too:
export const blog = {
  getPosts: async () => [],
  getLatestPost: async () => null,
  getPost: async () => null,
};
